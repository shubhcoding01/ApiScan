...
//   // 1. Fetch API Versions (Specs) on Load
//   useEffect(() => {
...
//         // Auto-select the most recent version if available
//         if (data.length > 0) {
...
//   // 2. Fetch Blueprints when Version Changes
//   useEffect(() => {
...
//     return (
//       <div className={`flex items-center gap-1.5 px-2.5 py-1 rounded-full text-xs font-medium border ${styles[status as keyof typeof styles] || styles.PENDING_APPROVAL}`}>
...
//           <p className="text-zinc-500 text-sm mt-1">Upload a Swagger/OpenAPI file in the Specs tab first.</p>
...
//           ) : (
//             blueprints.map((bp) => (
//               <Card key={bp.id} className="p-6 hover:border-zinc-600 transition-colors group">
...
//                       {bp.summary || "No summary provided. This blueprint contains automated test cases based on your API specification."}
//                     </p>
...
//                     <Button variant="secondary" className="group-hover:bg-blue-600 group-hover:text-white transition-colors">
//                       View Details
