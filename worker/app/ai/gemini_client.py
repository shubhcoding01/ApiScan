...
# 👇 FIX 1: Upgraded to Gemini 2.5 Flash (faster, smarter, and cheaper)
...
class GeminiClient:
    """
    Thin wrapper around Google Gemini API using the new google-genai SDK.
    """

    def __init__(self, model_name: str = MODEL_NAME):
        # 👇 FIX 2: Initialize the new SDK Client
    ...
    def generate(self, prompt: str, temperature: float = 0.3) -> str:
        ...
        """
        try:
            # 👇 FIX 3: Use the new models.generate_content syntax and types.GenerateContentConfig
